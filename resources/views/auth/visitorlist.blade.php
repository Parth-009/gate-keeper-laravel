...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <div class="d-flex justify-content-center mb-3">
      ...
      <button type="button" class="fa fa-plus btn btn-primary" style="width: ;height: 47px;margin-top: 30px;margin-left: 15;" onclick="window.location='{{ url('/addvisitor') }}'"> Add Visitor</button>
    </div>
